...
data:
  ...
  verifiedWith: [test/bigint/addition.test.cpp, test/bigint/division.test.cpp, test/bigint/multipication.test.cpp,
    test/bigint/multipication2.test.cpp, test/bigint/remainder.test.cpp, test/bigint/subtraction.test.cpp]
documentation_of: math/bigint.hpp
layout: document
redirect_from: [/library/math/bigint.hpp, /library/math/bigint.hpp.html]
