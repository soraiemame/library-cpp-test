...
data:
  ...
  attributes:
    links: ['https://en.wikipedia.org/wiki/Fenwick_tree']
  ...
  dependsOn: [atcoder/internal_type_traits.hpp]
...
layout: document
redirect_from: [/library/atcoder/fenwicktree.hpp, /library/atcoder/fenwicktree.hpp.html]
