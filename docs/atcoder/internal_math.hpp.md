...
data:
  ...
  attributes:
    links: ['https://en.wikipedia.org/wiki/Barrett_reduction']
  ...
  requiredBy: [atcoder/convolution.hpp, atcoder/math.hpp, atcoder/modint.hpp]
  timestamp: '2021-03-13 19:58:33+09:00'
  verificationStatus: LIBRARY_ALL_AC
  verifiedWith: [test/bigint/division.test.cpp, test/bigint/multipication.test.cpp,
    test/bigint/multipication2.test.cpp, test/bigint/remainder.test.cpp]
documentation_of: atcoder/internal_math.hpp
layout: document
redirect_from: [/library/atcoder/internal_math.hpp, /library/atcoder/internal_math.hpp.html]
