...
data:
  ...
  dependsOn: [atcoder/internal_math.hpp, atcoder/internal_type_traits.hpp]
  isVerificationFile: false
  path: atcoder/modint.hpp
  requiredBy: [atcoder/convolution.hpp]
...
layout: document
redirect_from: [/library/atcoder/modint.hpp, /library/atcoder/modint.hpp.html]
