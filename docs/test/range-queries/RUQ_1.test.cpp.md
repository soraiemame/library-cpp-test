...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_D']
...
layout: document
redirect_from: [/verify/test/range-queries/RUQ_1.test.cpp, /verify/test/range-queries/RUQ_1.test.cpp.html]
