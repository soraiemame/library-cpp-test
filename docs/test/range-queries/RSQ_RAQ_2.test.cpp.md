...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_G']
...
layout: document
redirect_from: [/verify/test/range-queries/RSQ_RAQ_2.test.cpp, /verify/test/range-queries/RSQ_RAQ_2.test.cpp.html]
