...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_E']
...
layout: document
redirect_from: [/verify/test/range-queries/RAQ_1.test.cpp, /verify/test/range-queries/RAQ_1.test.cpp.html]
