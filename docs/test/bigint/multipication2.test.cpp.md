...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/6/NTL/2/NTL_2_F']
...
layout: document
redirect_from: [/verify/test/bigint/multipication2.test.cpp, /verify/test/bigint/multipication2.test.cpp.html]
