...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/6/NTL/2/NTL_2_B']
...
layout: document
redirect_from: [/verify/test/bigint/subtraction.test.cpp, /verify/test/bigint/subtraction.test.cpp.html]
