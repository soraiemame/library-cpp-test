...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/6/NTL/2/NTL_2_D']
...
layout: document
redirect_from: [/verify/test/bigint/division.test.cpp, /verify/test/bigint/division.test.cpp.html]
