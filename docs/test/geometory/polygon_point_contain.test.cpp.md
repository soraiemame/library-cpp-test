...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_3_C']
...
layout: document
redirect_from: [/verify/test/geometory/polygon_point_contain.test.cpp, /verify/test/geometory/polygon_point_contain.test.cpp.html]
