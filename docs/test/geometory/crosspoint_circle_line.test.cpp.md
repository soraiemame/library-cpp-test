...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_7_D']
...
layout: document
redirect_from: [/verify/test/geometory/crosspoint_circle_line.test.cpp, /verify/test/geometory/crosspoint_circle_line.test.cpp.html]
