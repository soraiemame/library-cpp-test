...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_1_C']
...
layout: document
redirect_from: [/verify/test/geometory/CCW.test.cpp, /verify/test/geometory/CCW.test.cpp.html]
