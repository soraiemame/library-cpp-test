...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_5_A']
...
layout: document
redirect_from: [/verify/test/geometory/closest_pair.test.cpp, /verify/test/geometory/closest_pair.test.cpp.html]
