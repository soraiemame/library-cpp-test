...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_7_A']
...
layout: document
redirect_from: [/verify/test/geometory/intersect_circle.test.cpp, /verify/test/geometory/intersect_circle.test.cpp.html]
