...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_3_A']
...
layout: document
redirect_from: [/verify/test/geometory/area.test.cpp, /verify/test/geometory/area.test.cpp.html]
