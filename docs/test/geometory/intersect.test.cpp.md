...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_2_B']
...
layout: document
redirect_from: [/verify/test/geometory/intersect.test.cpp, /verify/test/geometory/intersect.test.cpp.html]
