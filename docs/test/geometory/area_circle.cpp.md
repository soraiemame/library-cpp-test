...
data:
  ...
  attributes:
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_7_I']
...
layout: document
redirect_from: [/library/test/geometory/area_circle.cpp, /library/test/geometory/area_circle.cpp.html]
