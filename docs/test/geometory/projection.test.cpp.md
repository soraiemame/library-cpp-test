...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_1_A']
...
layout: document
redirect_from: [/verify/test/geometory/projection.test.cpp, /verify/test/geometory/projection.test.cpp.html]
