...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_7_B']
...
layout: document
redirect_from: [/verify/test/geometory/incircle.test.cpp, /verify/test/geometory/incircle.test.cpp.html]
