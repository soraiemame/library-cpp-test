...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_2_A']
...
layout: document
redirect_from: [/verify/test/geometory/paralell_orthogonal.test.cpp, /verify/test/geometory/paralell_orthogonal.test.cpp.html]
