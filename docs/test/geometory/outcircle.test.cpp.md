...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_7_C']
...
layout: document
redirect_from: [/verify/test/geometory/outcircle.test.cpp, /verify/test/geometory/outcircle.test.cpp.html]
