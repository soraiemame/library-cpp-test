...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_2_D']
...
layout: document
redirect_from: [/verify/test/geometory/distance.test.cpp, /verify/test/geometory/distance.test.cpp.html]
