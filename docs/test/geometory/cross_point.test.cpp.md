...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_2_C']
...
layout: document
redirect_from: [/verify/test/geometory/cross_point.test.cpp, /verify/test/geometory/cross_point.test.cpp.html]
