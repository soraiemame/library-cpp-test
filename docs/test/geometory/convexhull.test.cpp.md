...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_4_A']
...
layout: document
redirect_from: [/verify/test/geometory/convexhull.test.cpp, /verify/test/geometory/convexhull.test.cpp.html]
