...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_7_F']
...
layout: document
redirect_from: [/verify/test/geometory/tangent_circle.test.cpp, /verify/test/geometory/tangent_circle.test.cpp.html]
