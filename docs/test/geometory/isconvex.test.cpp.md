...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_3_B']
...
layout: document
redirect_from: [/verify/test/geometory/isconvex.test.cpp, /verify/test/geometory/isconvex.test.cpp.html]
