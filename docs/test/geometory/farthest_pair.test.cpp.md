...
data:
  ...
  attributes:
    ...
    links: ['https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_4_B']
...
layout: document
redirect_from: [/verify/test/geometory/farthest_pair.test.cpp, /verify/test/geometory/farthest_pair.test.cpp.html]
